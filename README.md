...
Release: [v1.1.0](https://github.com/aconsciousfractal/FCIG-Minimum-Subspace-Trades-Relation-Lattices/releases/tag/v1.1.0).
...
- <code>certificates/legacy/</code> contains compact, hash-bound receipts for
  ...
  claims. The underlying large generation matrices are not included and are
  not treated as independently regenerated by this package.
...
~~~text
PASS_MINIMUM_SUBSPACE_TRADES_PUBLIC_PACKAGE
~~~
...
docs/          claim, source, and artifact boundaries
~~~
